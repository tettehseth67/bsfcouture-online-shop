                ...
                <div class="row">
                        ...
                        <div class="killore-new-block-link border mb-3 mt-3">
                            ...
                            <div class="killore--block-link-content">
                                <ul>
                                    ...
                                    <li><a href="javascript:void(0);"><i class="fas fa-gift"></i>Gifts & Cards</a>
                                    </li>
                                    ...
                                    <li><a href="javascript:void(0);"><i class="fas fa-football-ball"></i>Sports
                                            Items</a></li>
                                    <li class="px-2 my-2"><a href="javascript:void(0);"
                                            class="btn theme-bg rounded text-light">Get -60% Off</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12">
                        <div class="home-slider auto-slider mb-3 mt-3">
                            ...
                            <!-- Slide -->
                            <div data-background-image="https://via.placeholder.com/1500x700" class="item">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="home-slider-container">
                                                ...
                                                <div class="home-slider-desc">
                                                    <div class="home-slider-title mb-4">
                                                        ...
                                                        <h1 class="mb-2 ft-bold">The Standard<br>With <span
                                                                class="theme-cl">Smartness</span></h1>
                                                        <span class="trending">Xiomi Redmi 10 comes with 6.5 inches
                                                            full HD + LCD Screen</span>
                                                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <ul class="nav nav-tabs b-0 d-flex align-items-center justify-content-center simple_tab_links mb-4"
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" href="#mens" id="mens-tab" data-toggle="tab"
                                    role="tab" aria-controls="mens" aria-selected="false">Men's</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                                    ...
                                                    <div class="shop_thumb position-relative">
                                                        <a class="card-img-top d-block overflow-hidden"
                                                            href="shop-single-v1.html"><img class="card-img-top"
                                                                src="https://via.placeholder.com/625x800"
                                                                alt="..."></a>
                                                    ...
                                                    <div class="text-left">
                                                        <div class="text-left">
                                                            ...
                                                            <h5 class="fs-md mb-0 lh-1 mb-1"><a
                                                                    href="shop-single-v1.html">Women Striped Shirt
                                                                    Dress</a></h5>
                                                            <div class="elis_rty"><span
                                                                    class="ft-bold text-dark fs-sm">$99 - $129</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="text-left">
                                                        <div class="text-left">
                                                            ...
                                                            <h5 class="fs-md mb-0 lh-1 mb-1"><a
                                                                    href="shop-single-v1.html">Boys Solid
                                                                    Sweatshirt</a></h5>
                                                            <div class="elis_rty"><span
                                                ...
                                                <div
                                                    ...
                                                    <div class="text-left">
                                                        <div class="text-left">
                                                            ...
                                                            <h5 class="fs-md mb-0 lh-1 mb-1"><a
                                                                    href="shop-single-v1.html">Girls Floral Print
                                                                    Jumpsuit</a></h5>
                                                            <div class="elis_rty"><span
                                                                    class="ft-bold text-dark fs-sm">$99 - $129</span>
                                                            </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="text-left">
                                                        <div class="text-left">
                                                            ...
                                                            <h5 class="fs-md mb-0 lh-1 mb-1"><a
                                                                    href="shop-single-v1.html">Girls Solid A-Line
                                                                    Dress</a></h5>
                                                            <div class="elis_rty"><span
                                                                    class="ft-bold text-dark fs-sm">$50 - $149</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="text-left">
                                                        <div class="text-left">
                                                            ...
                                                            <h5 class="fs-md mb-0 lh-1 mb-1"><a
                                                                    href="shop-single-v1.html">Printed Straight
                                                                    Kurta</a></h5>
                                                            <div class="elis_rty"><span
                                                ...
                                                <div
                                                    ...
                                                    <div class="text-left">
                                                        <div class="text-left">
                                                            ...
                                                            <h5 class="fs-md mb-0 lh-1 mb-1"><a
                                                                    href="shop-single-v1.html">Women Printed A-Line
                                                                    Dress</a></h5>
                                                            <div class="elis_rty"><span
                                                                    class="ft-bold text-dark fs-sm">$110 - $600</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="text-left">
                                                        <div class="text-left">
                                                            ...
                                                            <h5 class="fs-md mb-0 lh-1 mb-1"><a
                                                                    href="shop-single-v1.html">Girls Fit and Flare
                                                                    Dress</a></h5>
                                                            <div class="elis_rty"><span
                                                                    class="ft-bold text-dark fs-sm">$99 - $110</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="text-left">
                                                        <div class="text-left">
                                                            ...
                                                            <h5 class="fs-md mb-0 lh-1 mb-1"><a
                                                                    href="shop-single-v1.html">Girls Self Design
                                                                    Jumpsuit</a></h5>
                                                            <div class="elis_rty"><span
                        ...
                        <div class="_blog_wrap">
                            <div class="_blog_thumb mb-2">
                                <a href="blog-detail.html" class="d-block"><img
                                        src="https://via.placeholder.com/1000x780" class="img-fluid rounded"
                                        alt="" /></a>
                            </div>
                            <div class="_blog_caption">
                                <span class="text-muted">26 Jan 2021</span>
                                <h5 class="bl_title lh-1"><a href="blog-detail.html">Let's start bring sale on this
            ...
            <div class="container-fluid p-0">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col">
                        <div class="_insta_wrap">
                            <div class="_insta_thumb">
                                <a href="javascript:void(0);" class="d-block"><img src="assets/img/i-1.png"
                    ...
                    <div class="col">
                        <div class="_insta_wrap">
                            <div class="_insta_thumb">
                                <a href="javascript:void(0);" class="d-block"><img src="assets/img/i-2.png"
                                        class="img-fluid" alt="" /></a>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="_insta_wrap">
                            <div class="_insta_thumb">
                                <a href="javascript:void(0);" class="d-block"><img src="assets/img/i-3.png"
                                        class="img-fluid" alt="" /></a>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="_insta_wrap">
                            <div class="_insta_thumb">
                                <a href="javascript:void(0);" class="d-block"><img src="assets/img/i-7.png"
                                        class="img-fluid" alt="" /></a>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="_insta_wrap">
                            <div class="_insta_thumb">
                                <a href="javascript:void(0);" class="d-block"><img src="assets/img/i-8.png"
                                        class="img-fluid" alt="" /></a>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="_insta_wrap">
                            <div class="_insta_thumb">
                                <a href="javascript:void(0);" class="d-block"><img src="assets/img/i-4.png"
                                        class="img-fluid" alt="" /></a>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="_insta_wrap">
                            <div class="_insta_thumb">
                                <a href="javascript:void(0);" class="d-block"><img src="assets/img/i-5.png"
                                        class="img-fluid" alt="" /></a>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="_insta_wrap">
                            <div class="_insta_thumb">
                                <a href="javascript:void(0);" class="d-block"><img src="assets/img/i-6.png"
                                        class="img-fluid" alt="" /></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="quick_view_wrap">
                            ...
                            <div class="quick_view_thmb">
                                <div class="quick_view_slide">
                                    <div class="single_view_slide"><img src="assets/img/product/1.jpg"
                                            class="img-fluid" alt="" /></div>
                                    <div class="single_view_slide"><img src="assets/img/product/2.jpg"
                                            class="img-fluid" alt="" /></div>
                                    <div class="single_view_slide"><img src="assets/img/product/3.jpg"
                                            class="img-fluid" alt="" /></div>
                                    <div class="single_view_slide"><img src="assets/img/product/4.jpg"
                                            class="img-fluid" alt="" /></div>
                                </div>
                            </div>
                            ...
                            <div class="cats_side_wrap text-center">
                                <div class="sl_cat_01">
                                    <div
                                        class="d-inline-flex align-items-center justify-content-center p-3 circle mb-2 gray">
                                        <a href="javascript:void(0);" class="d-block"><img
                                                src="assets/img/pant.png" class="img-fluid" width="40"
                                                alt="" /></a></div>
                                </div>
                                <div class="sl_cat_02">
